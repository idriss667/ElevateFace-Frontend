...
export default function Home() {
  ...
  return (
    <main className={`${dark ? "bg-black text-white" : "bg-white text-gray-900"} min-h-screen px-6 py-12 space-y-16 transition-all duration-500 ease-in-out font-sans`}>
      ...
      <section className="max-w-3xl mx-auto text-center mt-10">
        ...
        <div className="aspect-video">
          <iframe
            src="https://www.youtube.com/embed/VIDEO_ID" // Remplace VIDEO_ID par l'identifiant YouTube
