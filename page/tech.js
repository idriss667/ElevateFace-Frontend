...
export default function TechPage() {
  ...
  return (
    <main className={`${dark ? "bg-black text-white" : "bg-white text-gray-900"} min-h-screen px-6 py-12 space-y-12 transition-all duration-500 ease-in-out font-sans`}>
      ...
      <section className="text-center space-y-4">
        ...
        >
          Découvrez la structure technique derrière ElevateFace, pensée pour être robuste, sécurisée et évolutive.
        </motion.p>
      </section>
      ...
      <section className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-gradient-to-r from-green-100 to-teal-100 dark:from-green-900 dark:to-teal-900 p-6 rounded-lg shadow">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>Fichiers organisés par route : `analyze_face`, `subscribe`, `get_user_plan`.</li>
